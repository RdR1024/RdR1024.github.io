...
Unfortunately, there is an exception for ANZAC day, which does not result in a free workday if it happens to fall on a weekend.  This is purely a political ruling, so needs to be hard coded. 
