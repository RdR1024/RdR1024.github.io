...
```{r setup, echo=FALSE, purl=TRUE,message=FALSE,warning=FALSE}
#require(gamlss.rt, quietly=TRUE)
knitr::opts_chunk$set(comment="",highlight=TRUE,echo=TRUE)
```
...
```{r sim}
	source("./karyl.R")  # use k-ary tree probability
